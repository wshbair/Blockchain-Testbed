...
PRIVATE_CONFIG=/root/new-node-1t/tm.ipc nohup /root/quorum/build/bin/geth --datadir /root/new-node --nodiscover --verbosity 5 --networkid 31337 --raft --raftport 50000 --rpc --rpcaddr 0.0.0.0 --rpcport 22000 --allow-insecure-unlock --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,raft --emitcheckpoints --port 21000 >> node.log 2>&1 &
